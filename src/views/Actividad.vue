  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Analizando la información en la biblioteca
        p.mb-4 Fortalecer los conceptos de análisis de información y datos estadísticos para la prestación de servicios de bibliotecas, con base en los temas desarrollados en el componente formativo.
